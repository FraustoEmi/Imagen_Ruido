...
ruido2 = 0.45
ruido3 = 0.1
imagen_grises, imagen_ruido = fn.añadir_ruido('Ruido/imagenes/ana.jpg', ruido)
imagen_grises2, imagen_ruido2 = fn.añadir_ruido('Ruido/imagenes/ana.jpg', ruido2)
imagen_grises3, imagen_ruido3 = fn.añadir_ruido('Ruido/imagenes/ana.jpg', ruido3)
...
for i in range(3):
    for j in range(3):
        psnr_value = psnr(imagenes_ruido[i], predicciones[i][j])
